...
class TraitTags:
    ...
    Special_Pharmacy_Visit = "Special / Pharmacy Visit"
    ...
    Special_Various_Errands = "Special / Various Errands"
    Special_Various_Item_Shopping = "Special / Various Item Shopping"
